...
CREATE OR REPLACE VIEW roads AS 
	SELECT 
        ...
        CASE
            ...
            WHEN type IN ('path', 'track', 'living_street', 'service') THEN 'path'
            WHEN type IN ('footway', 'bridleway', 'cycleway', 'pedestrian', 'steps') THEN 'pedestrian'
            WHEN type IN ('construction', 'proposed') THEN 'proposed'
            WHEN type = 'rail' THEN 'rail'
